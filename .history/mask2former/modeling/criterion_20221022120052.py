...
class SetCriterion(nn.Module):
    ...
    def get_loss(self, loss, outputs, outputs_ema, targets, indices, num_masks, gt_instances=None):
        loss_map = {
    ...
    def compute_losses(self, outputs, outputs_ema, targets, batched_inputs):
        ...
        if "aux_outputs" in outputs:
            for i, aux_outputs in enumerate(outputs["aux_outputs"]):
                ...
                for loss in self.losses:
                    l_dict = self.get_loss(loss, aux_outputs, aux_outputs_ema, targets, indices, num_masks, gt_instances=gt_instances)
