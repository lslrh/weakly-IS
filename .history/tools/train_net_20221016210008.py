...
from adet.data import build_voc_detection_train_loader, build_detection_train_loader
from adet.data.dataset_mapper import DatasetMapperWithBasis
from adet.data.dataset_mapper_strong import DatasetMapperWithBasisPair
...
class Trainer(DefaultTrainer):
    ...
    def build_train_loader(cls, cfg):
        ...
        if cfg.MODEL.FCPOSE_ON:
            ...
            mapper = DatasetMapperWithBasisPair(cfg, True)
...
def main(args):
    ...
    if args.eval_only:
        ...
        A = Trainer.test_with_TTA(cfg, model)
...
if __name__ == "__main__":
    ...
    args.dist_url = "tcp://127.0.0.1:50162"
    launch(
        main,
        args.num_gpus,
