        ...
        if self.training:
            ...
            if len(pred_instances) == 0:
                ...
                if self.boxinst_enabled:
                    ...
                    loss_consistence = mask_focal_loss(mask_scores, (mask_scores_ema>0.5).detach())
                    ...
                    if self._iter > 0:
                        ...
                        loss_pseudo = (mask_focal_loss(mask_scores, pseudo_seg_final.float().detach(), weights)) * warmup_factor_2 * 0.3
