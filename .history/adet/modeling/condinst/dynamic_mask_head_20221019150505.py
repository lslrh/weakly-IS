            ...
            if len(pred_instances) == 0:
                ...
                if self.boxinst_enabled:
                    ...
                    for i in range(len(gt_instances[0].gt_boxes)):
                        ...
                        heat_1 = heat_map[w1:w2,h1:h2]

                        heat_1 = heat_1/heat_1.max()
                        heat_map = self.max_pooling_forward(heat_1, (16,16))*255   
                        heat_map = cv2.resize(heat_map.astype(np.uint8), (w2-w1,h2-h1))

                        heat_img_ = cv2.applyColorMap(heat_map, cv2.COLORMAP_JET)
