...
from adet.utils.show import show_feature_map, show_feature_map_v2, show_feature_map_v3, show_feature_map_v4, show_feature_map_heatmap
            ...
            if len(pred_instances) == 0:
                ...
                if self.boxinst_enabled:
                    ...
                    if self._iter > 0:
                        ...
                        show_feature_map(((proto_seg).float()).detach(), 4)
