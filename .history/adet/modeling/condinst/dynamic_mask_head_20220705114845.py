            ...
            if len(pred_instances) == 0:
                ...
                if self.boxinst_enabled:
                    ...
                    if self._iter > 20000:
                        ...
                        warmup_factor_2 = min(self._iter.item() / float(40000), 0.5)
