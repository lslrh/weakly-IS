...
def build_swin_backbone(cfg, input_shape):
    ...
    out_feature_channels = {"p0": 128, "p1": 256,
                            "p2": 512, "p3": 1024}
    out_feature_strides = {"p0": 4, "p1": 8, "p2": 16, "p3": 32}
    model = SwinTransformer(cfg, depths=[2,2,18,2], drop_path_rate=0.4, embed_dim=128, num_heads=[4,8,16,32])
